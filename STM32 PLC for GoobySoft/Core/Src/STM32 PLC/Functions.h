...
typedef enum {
	STM32PLC_SEND_BACK_CAN_MESSAGE_TYPE,
	STM32PLC_SEND_BACK_DIGITAL_IN_MESSAGE_TYPE,
	STM32PLC_SEND_BACK_ANALOG_IN_MESSAGE_TYPE,
	STM32PLC_SEND_BACK_ANALOG_DIFFERENTIAL_IN_MESSAGE_TYPE,
	STM32PLC_SEND_BACK_INPUT_CAPUTRE_MESSAGE_TYPE,
	STM32PLC_SEND_BACK_ENCODER_MESSAGE_TYPE,
	STM32PLC_SEND_BACK_PWM_PRESCALERS_MESSAGE_TYPE,
	STM32PLC_SEND_BACK_ANALOG_GAINS_MESSAGE_TYPE,
	STM32PLC_SEND_BACK_DATE_TIME_MESSAGE_TYPE,
	STM32PLC_SEND_BACK_ALARM_A_MESSAGE_TYPE,
	STM32PLC_SEND_BACK_ALARM_B_MESSAGE_TYPE,
	STM32PLC_WRITE_SET_CAN_BUS_MESSAGE_TYPE,
	STM32PLC_WRITE_SET_PWM_SIGNAL_MESSAGE_TYPE,
	STM32PLC_WRITE_SET_DAC_SIGNAL_MESSAGE_TYPE,
	STM32PLC_WRITE_SET_ANALOG_INPUT_GAIN_MESSAGE_TYPE,
	STM32PLC_WRITE_SET_PWM_PRESCALER_MESSAGE_TYPE,
	STM32PLC_WRITE_SET_DATE_TIME_MESSAGE_TYPE,
	STM32PLC_WRITE_SET_ALARM_A_MESSAGE_TYPE,
	STM32PLC_WRITE_SET_ALARM_B_MESSAGE_TYPE,
	STM32PLC_ACKNOWLEDGEMENT_MESSAGE_TYPE
}STM32PLC;
...
void STM32_PLC_CAN_Get_ID_Data(uint32_t *_IDE, uint32_t *_ID, uint8_t *_DLC, uint8_t data[], bool *_is_new_message);
