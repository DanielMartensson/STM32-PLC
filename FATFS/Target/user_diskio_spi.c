...
#define CS_HIGH()	{HAL_GPIO_WritePin(SD_CS_GPIO_Port, SD_SPI_CS_Pin, GPIO_PIN_SET);}
#define CS_LOW()	{HAL_GPIO_WritePin(SD_CS_GPIO_Port, SD_SPI_CS_Pin, GPIO_PIN_RESET);}
